...
# es_host = None
# neo_host = None
es_host = os.getenv("ES_CONTAINER_NAME")
...
# NEO4J_ENDPOINT = 'bolt://neo4j-amundsen:7687'
...
#    db = 'metastore_db'
    ...
    #return "mysql://admin:admin@localhost:3306/metastore_db" % (user, password, host, port, db)
...
def run_hive_metastore_job():
    ...
    job_config = ConfigFactory.from_dict({
        ...
        f'extractor.hive_table_metadata.{HiveTableMetadataExtractor.CLUSTER_KEY}': 'sepep',
...
if __name__ == "__main__":
    ...
    loading_job = run_hive_metastore_job()
    loading_job.launch()
